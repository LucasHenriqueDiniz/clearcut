...
// three.js is a third of the bundle and only draws the empty-state backdrop,
// so it loads after the shell is interactive rather than blocking it.
const ColorBends = lazy(() =>
  import("@/components/effects/color-bends").then((m) => ({ default: m.ColorBends })),
);
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    {state !== "done" ? (
                      <ProgressBar value={stateProgress(state)} state={state} className="mt-[5px]" />
                    ) : null}
                  </div>
